# Feature audit — Ozora 2026 Planner v4.1
...
- IS tags for Astrix, Merkaba, Asgard, Kalya Scintilla and Avalon.
...
- Browser interactions: language selection, first-start guide, search, rating range, comment, My Plan, Routing, First Timer, compact mode and QR dialog.
